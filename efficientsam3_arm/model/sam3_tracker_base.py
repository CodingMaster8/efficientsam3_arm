...
from efficientsam3_arm.model.memory import SimpleMaskEncoder

from efficientsam3_arm.model.sam3_tracker_utils import get_1d_sine_pe, select_closest_cond_frames

from efficientsam3_arm.sam.mask_decoder import MaskDecoder, MLP
from efficientsam3_arm.sam.prompt_encoder import PromptEncoder
from efficientsam3_arm.sam.transformer import TwoWayTransformer
from efficientsam3_arm.model.data_misc import BatchedDatapoint
...
class Sam3TrackerBase(torch.nn.Module):
    ...
    def _get_tpos_enc(self, rel_pos_list, device, max_abs_pos=None, dummy=False):
        ...
        pos_enc = (
            torch.tensor(rel_pos_list, device=device)
            / t_diff_max
        )
    ...
    def _compile_all_components(self):
        ...
        from efficientsam3_arm.perflib.compile import compile_wrapper
